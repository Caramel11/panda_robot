...
# 读取Excel文件
root = "/home/hjh/ljj_ws/logs/0124_MPC_KF"
time_str = "MPC_KF_20260125_052949"
...
# ax3 = axes1[1]
# ax3.plot(range(V_h.size), V_h, label="V_h")
# ax3.legend()
...
# ax5 = axes2[0]
# ax5.plot(range(dF_h.size), dF_h, label="F_h")
# ax5.legend()
# ax5.grid(True, alpha=0.3)

# ax6 = axes2[1]
# ax6.plot(range(dV_h.size), dV_h, label="V_h")
# ax6.legend()
# ax6.grid(True, alpha=0.3)

# ax7 = axes2[2]
# ax7.plot(range(dD_r.size), dD_r, label="D_r")
# ax7.legend()
